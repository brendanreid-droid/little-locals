          ...
          {post.image_urls && post.image_urls.length > 0 && (
            ...
            <div style={{ 
              ...
              <h4 style={{ 
                ...
                <Share2 size={18} /> Share this review with other parents!
              </h4>
              ...
              <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                ...
                <a 
                  href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent("Check out this great review: " + post.title)}`} 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="share-btn-hover"
                  style={{ 
                ...
                <a 
                  href={`https://api.whatsapp.com/send?text=${encodeURIComponent("Check out this great review: " + post.title + " - " + window.location.href)}`} 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="share-btn-hover"
                  style={{ 
